...
class getKonectaController extends Controller
{
	...
	public function index()
    {
        ...
        $tickets = Ticket::where('queue', Sector::KONECTA_TECNICA)->get();
		...
		return view('getKonecta')->with('ticketsOpen', $ticketsOpen);

    }

    public function getTicketsKonecta()
    {   
        

    	$ticketsAll = Ticket::where('queue', Sector::KONECTA_TECNICA)->get();
